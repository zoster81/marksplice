...
- [Roadmap](roadmap.md) — approved post-M115 development sequence; M116–M119 are complete, M120 follows after exact M119 remote closure, and M124/M126 remain the v1.0/v1.5 release gates.
...
- [`milestones/`](milestones/) — M0–M119 feature/design/test records; M119 is locally frozen complete and still requires exact remote CI verification before M120 begins.
