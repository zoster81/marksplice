...
- [Roadmap](roadmap.md) — approved post-M115 development sequence; M116–M120 are complete locally, M121 follows after exact M120 remote closure, and M124/M126 remain the v1.0/v1.5 release gates.
...
- [`milestones/`](milestones/) — M0–M120 feature/design/test records; M120 records the HTML-fragment renderer and its conformance/performance boundary.
