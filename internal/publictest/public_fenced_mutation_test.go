...
func TestPrepareSetFencedBlockInfoPreservesContainerTrivia(t *testing.T) {
	t.Parallel()
...
func TestPrepareReplaceFencedCodePopulatesProvenEmptyClosedBlock(t *testing.T) {
	t.Parallel()
...
func TestFencedMutationsRemainSourceBoundAndFailClosed(t *testing.T) {
	t.Parallel()
