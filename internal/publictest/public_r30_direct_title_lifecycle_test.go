...
func TestR30DirectLinkAndImageTitleLifecyclePreservesUnownedTrivia(t *testing.T) {
	t.Parallel()
...
func TestR30DirectTitleLifecycleFailsClosedAndRemainsSnapshotBound(t *testing.T) {
	t.Parallel()
