...
func TestStandaloneHTMLDocumentMapsReviewedFrontMatterMetadata(t *testing.T) {
	t.Parallel()
...
func TestStandaloneHTMLDocumentMetadataIsNarrowAndOptional(t *testing.T) {
	t.Parallel()
...
func TestStandaloneHTMLDocumentReusesFragmentPoliciesAndErrors(t *testing.T) {
	t.Parallel()
...
func TestStandaloneHTMLDocumentHandlesTOMLAndDuplicateMetadataFailClosed(t *testing.T) {
	t.Parallel()
...
func TestStandaloneHTMLDocumentRejectsAmbiguousMetadataValuesWithoutRejectingDocument(t *testing.T) {
	t.Parallel()
