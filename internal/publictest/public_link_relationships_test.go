...
func TestLinkRelationshipsCoverDirectReferenceImageAndAutoLinkForms(t *testing.T) {
	t.Parallel()
...
func TestLinkRelationshipsIncludeBareGFMAutolinks(t *testing.T) {
	t.Parallel()
...
func TestLinkRelationshipsExcludeRecognizedFrontMatterEnvelope(t *testing.T) {
	t.Parallel()
...
func TestReferenceRelationshipKeepsSemanticResolutionWithoutPromotedDefinitionOwner(t *testing.T) {
	t.Parallel()
...
func TestUnresolvedReferenceSyntaxDoesNotCreateRelationship(t *testing.T) {
	t.Parallel()
...
func TestLinkRelationshipFragmentStatusReusesResolution(t *testing.T) {
	t.Parallel()
