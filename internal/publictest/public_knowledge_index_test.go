...
func TestKnowledgeIndexAddsSyntaxIndependentAliasesTagsAndLogicalReferences(t *testing.T) {
	t.Parallel()
...
func TestKnowledgeIndexAllowsSubsetMetadataSelfReferenceAndEmptyGraph(t *testing.T) {
	t.Parallel()
...
func TestKnowledgeIndexRejectsMalformedMetadata(t *testing.T) {
	t.Parallel()
...
func TestKnowledgeIndexNilBehavior(t *testing.T) {
	t.Parallel()
