...
func TestFrontMatterEnvelopeIsReadableWithoutEditableFields(t *testing.T) {
	t.Parallel()
...
func TestComplexFrontMatterIsOpaqueToMarkdownIntelligence(t *testing.T) {
	t.Parallel()
...
func TestFrontMatterFieldPromotionRemainsConservative(t *testing.T) {
	t.Parallel()
...
func TestEmptyLeadingYAMLUsesFrontMatterPrecedence(t *testing.T) {
	t.Parallel()
...
func TestFrontMatterDoesNotGuessUnclosedNonLeadingOrMetadataFreeEnvelope(t *testing.T) {
	t.Parallel()
