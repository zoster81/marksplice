...
func TestFootnoteMultilineBodyMutationPreservesContainerLayout(t *testing.T) {
	t.Parallel()
...
func TestAppendFootnoteDefinitionResolvesExistingReference(t *testing.T) {
	t.Parallel()
...
func TestRemoveFootnoteDefinitionLeavesOccurrenceUnresolved(t *testing.T) {
	t.Parallel()
...
func TestFootnoteLifecycleFailsClosed(t *testing.T) {
	t.Parallel()
