...
func TestExtensionValidationIsFailClosedAndBudgeted(t *testing.T) {
	t.Parallel()
		...
		},
		{
			...
			options: marksplice.ParseOptions{
				Extensions: []marksplice.Extension{
					{ID: "example.org/dup", Recognize: noMatches},
					{ID: "example.org/dup", Recognize: noMatches},
				},
...
func TestExtensionConfigurationIsPrevalidatedBeforeCallbacks(t *testing.T) {
	t.Parallel()
...
func TestExtensionOutputValidationAndPanicAreAllOrNothing(t *testing.T) {
	t.Parallel()
...
func TestParseWithZeroOptionsKeepsBaselineBehavior(t *testing.T) {
	t.Parallel()
...
func TestExtensionOrderAndOverlapRemainSeparateFromCore(t *testing.T) {
	t.Parallel()
...
func TestExtensionNodesSupportConcurrentReads(t *testing.T) {
	t.Parallel()
...
func noMatches(marksplice.ExtensionSource) ([]marksplice.ExtensionMatch, error) {
	return nil, nil
}
