...
func TestDirectLinkAndImageContentMutationsPreserveOwnedSyntax(t *testing.T) {
	t.Parallel()
...
func TestDirectLinkAndImageExistingTitleMutationsPreserveDelimiterAndTrivia(t *testing.T) {
	t.Parallel()
...
func TestDirectLinkAndImageRicherMutationsFailClosed(t *testing.T) {
	t.Parallel()
