...
func TestPublicHTMLRendererStreamsDeterministicFragment(t *testing.T) {
	t.Parallel()
...
func TestPublicHTMLRendererPoliciesAreExplicit(t *testing.T) {
	t.Parallel()
...
func TestPublicHTMLRendererNormalizesDestinationsTitlesAndFenceLanguage(t *testing.T) {
	t.Parallel()
...
func TestPublicHTMLRendererPathologicalInputIsDeterministicAndSourcePreserving(t *testing.T) {
	t.Parallel()
...
func TestPublicHTMLRendererRejectsInvalidInputsAndPropagatesWriterError(t *testing.T) {
	t.Parallel()
