...
func TestR30BlockquoteContentReplacementReusesProvenPrefixAndEOL(t *testing.T) {
	t.Parallel()
...
func TestR30BlockquoteContentReplacementFailsClosedForMixedOrAlertOwnership(t *testing.T) {
	t.Parallel()
...
func TestR30AlertKindAndBodyMutationPreserveBlockquoteTrivia(t *testing.T) {
	t.Parallel()
...
func TestR30AlertMutationRejectsInvalidKindMixedBodyAndStaleSource(t *testing.T) {
	t.Parallel()
