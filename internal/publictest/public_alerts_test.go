...
func TestAlertsRecognizeExactTopLevelGitHubAlertMarkers(t *testing.T) {
	t.Parallel()
...
func TestAlertBodyRangesPreservePhysicalSourceAndAreCallerOwned(t *testing.T) {
	t.Parallel()
...
func TestAlertsRejectMalformedMarkerOnlyAndNestedShapes(t *testing.T) {
	t.Parallel()
...
func TestDocumentBuilderWritesCanonicalSingleParagraphAlerts(t *testing.T) {
	t.Parallel()
...
func TestDocumentBuilderWritesCanonicalMultiBlockAlert(t *testing.T) {
	t.Parallel()
...
func TestDocumentBuilderRejectsInvalidAndNestedAlertConstruction(t *testing.T) {
	t.Parallel()
...
func TestAlertUnderlyingBlockquoteKeepsExistingRemovalContract(t *testing.T) {
	t.Parallel()
