...
func TestR30ParagraphStructuralMutationsOwnSeparatorsAndPreserveNeighbors(t *testing.T) {
	t.Parallel()
...
func TestR30ParagraphStructuralMutationsFailClosedAndRemainSnapshotBound(t *testing.T) {
	t.Parallel()
