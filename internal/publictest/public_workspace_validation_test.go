...
func TestValidateWorkspaceReportsBrokenRelationshipsOrphansAndStaleTOC(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceReportsUnrecognizedManagedTOCWithoutRepair(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceComposesMultipleManagedTOCRepairsPerDocument(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceExcludesFrontMatterAndAmbiguousShortcutTextFromUnresolvedReferences(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceUsesMultiRootReachabilityWithoutDuplicateTraversalSemantics(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceRejectsMalformedAuthorityAndTargets(t *testing.T) {
	t.Parallel()
...
func TestValidateWorkspaceEmptyAndNilReportBehavior(t *testing.T) {
	t.Parallel()
