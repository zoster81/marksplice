...
func TestReferenceOccurrenceRetargetsAllSupportedForms(t *testing.T) {
	t.Parallel()
...
func TestReferenceDefinitionRenamePreservesVisibleOccurrenceLabels(t *testing.T) {
	t.Parallel()
...
func TestAppendReferenceDefinitionResolvesExplicitOccurrences(t *testing.T) {
	t.Parallel()
...
func TestReferenceDefinitionTitleLifecycle(t *testing.T) {
	t.Parallel()
...
func TestReferenceLifecycleFailsClosed(t *testing.T) {
	t.Parallel()
