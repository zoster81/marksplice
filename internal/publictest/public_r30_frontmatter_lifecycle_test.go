...
func TestR30FrontMatterFieldLifecyclePreservesEnvelopeAndBody(t *testing.T) {
	t.Parallel()
...
func TestR30FrontMatterEnvelopeLifecycleUsesProvenEOL(t *testing.T) {
	t.Parallel()
...
func TestR30FrontMatterLifecycleFailsClosedOnAmbiguityAndUnsafeSource(t *testing.T) {
	t.Parallel()
