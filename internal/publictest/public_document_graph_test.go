...
func TestDocumentGraphBuildsResolvedEdgesBacklinksReachabilityAndRelatedDocuments(t *testing.T) {
	t.Parallel()
...
func TestDocumentGraphResolverIsBuildOnlyAndCrossDocumentFragmentsReuse(t *testing.T) {
	t.Parallel()
...
func TestDocumentGraphWithoutResolverStillIncludesLocalFragmentsOnly(t *testing.T) {
	t.Parallel()
...
func TestDocumentGraphRejectsMalformedInputsAndResolverTargets(t *testing.T) {
	t.Parallel()
