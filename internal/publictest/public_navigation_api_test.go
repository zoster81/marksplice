...
func TestHeadingAnchorsFollowGitHubRulesAndReserveDuplicates(t *testing.T) {
	t.Parallel()
...
func TestFragmentResolutionSupportsEncodingExplicitAnchorsAndAmbiguity(t *testing.T) {
	t.Parallel()
...
func TestGenerateTOCUsesSectionHierarchyAndEscapesLabels(t *testing.T) {
	t.Parallel()
...
func TestTOCStalenessAndSourcePreservingSynchronization(t *testing.T) {
	t.Parallel()
...
func TestTOCSyncPreservesBlankOnlyBodyPrefix(t *testing.T) {
	t.Parallel()
...
func TestTOCSyncFailsClosedForArbitrarySectionBodies(t *testing.T) {
	t.Parallel()
