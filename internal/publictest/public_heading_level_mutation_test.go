...
func TestSetHeadingLevelPreservesReviewedSourceTrivia(t *testing.T) {
	t.Parallel()
...
func TestSetHeadingLevelRecomputesSectionHierarchyWithoutChangingOtherHeadings(t *testing.T) {
	t.Parallel()
...
func TestSetHeadingLevelFailsClosedForInvalidOrUnrepresentableTargets(t *testing.T) {
	t.Parallel()
